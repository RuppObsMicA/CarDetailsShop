...
export const SignInSignUpHeader = ({toggleSignInSignUp, setToggleSignInSignUp}:SignInSignUpHeaderProps) => {
    ...
    return (
        <div className="signin-signup-form__links">
            <ul className="signin-signup-form__navigation">
                <li className={toggleSignInSignUp === 'signIn'
                ...
                <li className={toggleSignInSignUp === 'signUp'
